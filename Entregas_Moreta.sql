...
create table PAQUETE (
   ...
   CONSTRAINT fecha_entrega_posterior CHECK (FECHA_ENTREGA >= FECHA_ENVIO)
);
...
alter table PAQUETE
   add constraint FK_PAQUETE_CAMIONERO_CHOFER foreign key (CI)
      references CHOFER (CI)
      on delete restrict on update restrict;

alter table PAQUETE
   add constraint FK_PAQUETE_CLIENTE_P_CLIENTE foreign key (CEDULA)
...
--PAQUETE
INSERT INTO PAQUETE (CODIGO_PAQUETE, CI, CODIGO_CIUDAD, CEDULA, DIRECCION_PAQUETE, FECHA_ENVIO, ESTADO, COSTO_ENVIO, FECHA_ENTREGA)
VALUES
   ('001', '1234567890', 'GYE', '1303753618', 'Av. Principal', '2023-06-01', 'Rechazado', '50,00', '2023-06-05'),
   ('002', '1725661183', 'UIO', '1706172648', 'Calle Principal', '2023-06-02', 'Entregado', '80,00', '2023-06-06'),
   ('003', '1725661191', 'CUE', '0100967652', 'Av. 9 de Octubre', '2023-06-03', 'Entregado', '100,00', '2023-06-04'),
   ('004', '1725842991', 'SNC', '1103037048', 'Av. Quito', '2023-06-04', 'Entregado', '70,00', '2023-06-07'),
   ('005', '1725888739', 'AMB', '1704997012', 'Av. 10 de Agosto', '2023-06-05', 'Rechazado', '120,00', '2023-06-08'),
   ('006', '1725888738', 'ESM', '1714818299', 'Av. Amazonas', '2023-06-06', 'Rechazado', '90,00', '2023-06-09'),
   ('007', '1785618731', 'MNT', '1713627071', 'Av. Solanda', '2023-06-07', 'Entregado', '60,00', '2023-06-10'),
   ('008', '1725998236', 'LOJ', '0200982163', 'Av. Los Alamos', '2023-06-08', 'Entregado', '150,00', '2023-06-11'),
   ('009', '1103077556', 'IBB', '0913537742', 'Av. 9 de Octubre', '2023-06-09', 'Entregado', '80,00', '2023-06-12'),
   ('010', '1714176813', 'MAC', '0401197298', 'Av. Juan Montalvo', '2023-06-10', 'Entregado', '110,00', '2023-06-13');
select * from paquete
